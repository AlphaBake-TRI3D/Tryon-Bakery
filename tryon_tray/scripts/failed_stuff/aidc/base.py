...
def logApiError(appkey, sdkVersion, requestUrl, code, message):
    try:
        ...
        localIp = "127.0.0.1"  # Use localhost if hostname resolution fails
    try:
...
class IopClient(object):
    ...
    def execute(self, request,access_token = None):
        print("\nDebug: Starting request execution")
        sys_parameters = {
        ...
        print("\nDebug: System parameters:", sys_parameters)
        ...
        print("\nDebug: Application parameters:", application_parameter)

        sign_parameter = sys_parameters.copy()
        sign_parameter.update(application_parameter)

        sign_parameter[P_SIGN] = sign(self._app_secret, request, sign_parameter)
        print("\nDebug: Sign parameters:", sign_parameter)
        ...
        try:
            ...
            print("\nDebug: Response status code:", r.status_code)
            print("\nDebug: Response headers:", r.headers)
            print("\nDebug: Response content:", r.text[:500])  # Print first 500 chars of response
        except Exception as err:
            print("\nDebug: Request failed with error:", str(err))
